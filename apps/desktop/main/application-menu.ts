    ...
    const template: MenuItemConstructorOptions[] = [
        ...
        },
        {
            ...
            submenu: [
                ...
                {label: 'Toggle Starred', accelerator: 'CmdOrCtrl+D', click: () => send('toggle-starred')},
                {label: 'Toggle Read Later', accelerator: 'CmdOrCtrl+Shift+D', click: () => send('toggle-read-later')},
                {label: 'Edit Tags…', accelerator: 'CmdOrCtrl+Alt+T', click: () => send('edit-tags')},
